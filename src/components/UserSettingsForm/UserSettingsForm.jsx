...
const UserSettingsForm = ({ onClose }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      formData.append('avatar', avatarFile ? avatarFile : userData.avatar);
      formData.append('dailyActivityTime', data.time);
      formData.append('dailyWaterNorm', data.water);
              ...
              <div className={css.midContainer}>
                <div className={`${css.userInfoInputContainer} ${css.amount}`}>
                  ...
                  <p className={css.textAccent}>{`${
                    amount ? amount : userData.dailyWaterNorm
                  } L`}</p>
                </div>
              </div>
              <div className={css.userInfoInputContainer}>
